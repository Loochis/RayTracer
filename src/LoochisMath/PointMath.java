...
public class PointMath {
     ...
     */
    public static void rotateAroundZ(Point r, Point pivot, float d) {
        ...
        r.setZ(pivot.getZ());
        r = VectorMath.Add(r, pivot); // translate back to global-space
    }
     ...
     * @param d number in radians to rotate by (+)=CW, (-)=CCW
     */
    public static void rotateAroundY(Point r, Point pivot, float d) {
     ...
     * @param d number in radians to rotate by (+)=CW, (-)=CCW
     */
    public static void rotateAroundX(Point r, Point pivot, float d) {
     ...
     */
    public static void scaleAround(Point r, Point pivot, float d) {
